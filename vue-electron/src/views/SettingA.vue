          ...
          <div class="appearance">
            ...
            <div class="appearance_options">
              <div class="option">
                ...
                <div class="font_size">
                  <p class="letter size_s"><span>A</span></p>
                  <p class="letter size_m select"><span>A</span></p>
                  <p class="letter size_l"><span>A</span></p>
                </div>
              </div>
              ...
              <div class="option">
                ...
                <div class="themes">
                  <div class="color_circle"><span class="color c_purple active_color"></span></div>
